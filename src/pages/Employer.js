...
export const Employer = () => {
  ...
  return (
    <div className="flex flex-col items-center md:flex-row  text-white border-2">
      ...
      <div className="w-3/4 p-4 flex flex-col space-y-4 items-center bg-[url('appl.avif')] bg-cover bg-center">
        <h1 className='text-2xl'>Posted Jobs</h1>
